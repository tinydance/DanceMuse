#!/bin/bash
#
#SBATCH --job-name=TinyDancer_Video_Extraction
#SBATCH --output=/zooper2/tinydancer/dances/pose_log.txt
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
#/zooper2/tinydancer/dances/pose_extract.sh -i INPUT_DIR -o OUTPUT_DIR -r FSP -d DURATION
