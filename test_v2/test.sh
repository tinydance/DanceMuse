...
source_dir="/zooper2/tinydancer/DanceMuse/DR-NEW"
duration="60"
fps="30"
...
cd $source_dir
/zooper2/tinydancer/DanceRevolution/bin/python prepro_audio_only.py --input_audio_dir "${edited_audio}" \
	--test_dir "${test_audio}"
...
##############
echo "<--Running Model-->"
sbatch -W /zooper2/tinydancer/DanceMuse/test_v2/slurm.sh
wait
###################
# Postprocessing ##
###################
