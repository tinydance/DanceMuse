...
image_dir="${work_dir}/test_output/0405-4k.outputs.test.images"
json_dir="${work_dir}/test_output/0405-4k.outputs.test.json"
input_dir="${work_dir}/test_audio"
output_dir="${work_dir}/test_output"
model="/zooper2/tinydancer/DanceRevolution/trained_models/jpop_0402/epoch_4000.pt"
